...
### The Potsdam Commenraty Corpus - RST annotations
...
For the DISRPT shared tasks, the data is divided into `train`, `dev`, and`test` partitions, 
...
fused tokens such as 'im', 'ins' etc. are retained in the data without CoNLL-U MWTs.
